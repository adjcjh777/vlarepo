...
const contentIntroSlides = [
  {
    title: '课程任务与研究对象',
    subtitle: '本次作业聚焦 5 家以“模式识别”为核心技术的全球科技公司',
    leftTitle: '作业要求',
    leftItems: [
      '在全球范围内选取 5 家以模式识别为核心技术的科技公司。',
      '系统梳理其主要产品、技术亮点、创业团队、经营情况和发展前景。',
      '最终形成约 100 页 PPT，用于课堂交流分享。',
      '重点不是罗列公司简介，而是分析“模式识别如何转化为商业价值”。',
    ],
    rightTitle: '本次选取的 5 家公司',
    rightItems: [
      'SenseTime：视觉识别与多模态平台代表。',
      'iFLYTEK：语音识别与行业 AI 平台代表。',
      'Cognex：工业机器视觉代表。',
      'SoundHound AI：语音交互与任务型 agent 代表。',
      'Facephi：生物识别与数字身份代表。',
    ],
  },
  {
    title: '模式识别的核心内涵',
    subtitle: '模式识别的任务，是让机器从复杂信号中发现结构、完成识别、匹配与判断',
    leftTitle: '典型对象',
    leftItems: [
      '语音：语音识别、说话人识别、情感与意图理解。',
      '图像与视频：分类、检测、分割、跟踪、人脸与行为识别。',
      '文本与序列：分类、匹配、异常发现、时间序列理解。',
      '生物与工业信号：身份验证、缺陷检测、风险识别。',
    ],
    rightTitle: '典型任务',
    rightItems: [
      '分类：判断输入属于哪一类。',
      '检测：从复杂环境中找出目标与位置。',
      '匹配：判断两个对象是否属于同一身份或同一模式。',
      '异常发现：识别偏离正常模式的行为与信号。',
      '序列理解：处理具有时间依赖的连续输入。',
    ],
  },
  {
    title: '模式识别如何创造商业价值',
    subtitle: '从“能识别”到“能完成业务流程”，是模式识别企业的关键跃迁',
    leftTitle: '价值形成链路',
    leftItems: [
      '第一步：把复杂世界转成机器可理解的数据表示。',
      '第二步：把识别结果接入系统与流程，而不是停留在模型输出。',
      '第三步：让企业在效率、成本、风险控制和体验上获得直接收益。',
      '第四步：通过数据回流、产品复用和客户扩展形成正向飞轮。',
    ],
    rightTitle: '因此我们要重点观察',
    rightItems: [
      '公司卖的是算法、平台、硬件，还是完整流程方案。',
      '技术是否进入高价值、高门槛、高粘性场景。',
      '收入增长是否由真实落地驱动，而不仅是概念热度推动。',
      '公司是否具备跨越下一轮技术周期的升级能力。',
    ],
  },
  {
    title: '五家公司总览',
    subtitle: '同为模式识别公司，但它们对应的模态、场景与商业逻辑差异很大',
    cards: [
      ['SenseTime', '从计算机视觉龙头转向 AI 基础设施、多模态模型和智能汽车。'],
      ['iFLYTEK', '以中文语音识别起家，逐步构建行业 AI 平台与开放生态。'],
      ['Cognex', '把机器视觉深度嵌入制造与物流，是工业场景成熟样本。'],
      ['SoundHound AI', '把语音识别升级为可以执行业务流程的 Voice AI agent。'],
      ['Facephi', '专注数字身份验证、活体检测与行为生物识别，是安全场景代表。'],
    ],
  },
];

const contentComparisonSlides = [
  {
    title: '全球模式识别公司的五条典型路线',
    subtitle: '本次案例选择，尽量覆盖模式识别商业化最重要的五种方向',
    leftTitle: '按技术模态看',
    leftItems: [
      '视觉与多模态：SenseTime',
      '语音与认知：iFLYTEK',
      '工业视觉：Cognex',
      '语音交互与 agent：SoundHound AI',
      '生物识别与身份安全：Facephi',
    ],
    rightTitle: '按场景价值看',
    rightItems: [
      '平台型：商汤、讯飞更强调可复用能力与生态。',
      '基础设施型：Cognex 更强调可靠性和长期工业部署。',
      '流程型：SoundHound AI 强调在餐饮、客服、汽车中直接完成任务。',
      '安全型：Facephi 强调可信身份、反欺诈与合规能力。',
    ],
  },
  {
    title: '横向比较：技术路线与产品化方式',
    subtitle: '同样是模式识别，客户购买对象却完全不同',
    leftTitle: '技术路线',
    leftItems: [
      'SenseTime：视觉识别升级为多模态与 AI 基础设施。',
      'iFLYTEK：语音识别升级为行业大模型与平台服务。',
      'Cognex：机器视觉与工业硬件/软件一体化。',
      'SoundHound AI：语音识别与会话理解升级为任务代理。',
      'Facephi：生物识别升级为数字身份平台。',
    ],
    rightTitle: '产品化方式',
    rightItems: [
      '平台服务：SenseTime、iFLYTEK、Facephi。',
      '硬件 + 软件：Cognex。',
      '白标语音代理与垂直系统：SoundHound AI。',
      '结论：高质量模式识别公司，通常不是只卖一个模型接口。',
    ],
  },
  {
    title: '横向比较：经营质量与护城河',
    subtitle: '规模、增长、客户粘性和壁垒来源，是判断公司质量的关键',
    leftTitle: '经营质量',
    leftItems: [
      'Cognex：成熟度高、现金质量强、工业客户稳定。',
      'iFLYTEK：规模最大，收入广，但仍处于大模型再投入阶段。',
      'SenseTime：完成收入结构切换后，平台化能力正在被重新定价。',
      'SoundHound AI：成长性强，但并购整合带来波动。',
      'Facephi：规模较小但 ARR、留存和垂直场景质量较好。',
    ],
    rightTitle: '护城河来源',
    rightItems: [
      '商汤：数据、算力平台、政企与车企部署经验。',
      '讯飞：中文语音、行业数据、开发者生态、本地化部署。',
      'Cognex：硬件+软件一体化与工业现场经验。',
      'SoundHound AI：复杂语音理解、白标模式、垂直场景积累。',
      'Facephi：合规、活体检测、身份流程编排和高留存。',
    ],
  },
  {
    title: '结论与总体启发',
    subtitle: '模式识别公司最有价值的时候，是它把识别能力做成了系统能力',
    leftTitle: '五家公司的一句话总结',
    leftItems: [
      'SenseTime：识别资产平台化。',
      'iFLYTEK：识别能力行业化。',
      'Cognex：识别能力工业化。',
    ...
    rightTitle: '我的总体启发',
    rightItems: [
      '模式识别没有过时，而是在多模态和 agent 时代变得更底层。',
      '真正强的公司，都会把识别能力嵌入高价值工作流。',
      '越是高门槛场景，越欢迎专业模式识别公司长期存在。',
      '未来的竞争重点，不是单点精度，而是技术、系统与场景的整体能力。',
    ],
  },
];
...
function addScenarioSlide(company) {
  const slide = pptx.addSlide();
  slideNo += 1;
  addHeader(slide, `${company.name}：典型应用场景与客户价值`, '模式识别真正有价值，是因为它被嵌进了具体业务流程', company.accent, company.en);
  addCard(slide, 0.6, 1.7, 6.0, 4.6);
  addCard(slide, 6.75, 1.7, 5.98, 4.6);
  slide.addText('典型应用场景', {
    x: 0.88, y: 1.92, w: 2.6, h: 0.2,
    fontFace: 'Microsoft YaHei', fontSize: 16, bold: true, color: C.ink, margin: 0,
  });
  const scenarios = Array.from(new Set([
    ...(company.spotlightA.useCases || []),
    ...(company.spotlightB.useCases || []),
  ])).slice(0, 6);
  bulletBlock(slide, scenarios, 0.92, 2.28, 5.15, 3.3, 15);
  slide.addText('为客户带来的价值', {
    x: 7.02, y: 1.92, w: 2.6, h: 0.2,
    fontFace: 'Microsoft YaHei', fontSize: 16, bold: true, color: C.ink, margin: 0,
  });
  const values = [
    '提升识别精度与自动化程度，减少人工成本。',
    '让企业流程更快、更稳、更容易规模化复制。',
    '把识别结果直接转成收入增长、风险降低或体验提升。',
    '在高门槛行业中形成更强客户粘性与更长合作周期。',
  ];
  bulletBlock(slide, values, 7.05, 2.28, 5.1, 3.3, 15);
  addFooter(slide, company.accent, company.sourceNote);
  warnIfSlideHasOverlaps(slide, pptx);
  warnIfSlideElementsOutOfBounds(slide, pptx);
}
...
function addPositionSlide(company) {
  const slide = pptx.addSlide();
  slideNo += 1;
  addHeader(slide, `${company.name}：战略位置与综合判断`, '把技术、商业与前景合在一起，看这家公司站在什么位置', company.accent, company.en);
  addCard(slide, 0.6, 1.7, 6.0, 4.85);
  addCard(slide, 6.75, 1.7, 5.98, 4.85);
  slide.addText('当前战略位置', {
    x: 0.88, y: 1.92, w: 2.4, h: 0.2,
    fontFace: 'Microsoft YaHei', fontSize: 16, bold: true, color: C.ink, margin: 0,
  });
  bulletBlock(slide, [company.tag, ...company.highlights.slice(0, 3)], 0.92, 2.28, 5.2, 3.45, 14.5);
  slide.addText('综合判断', {
    x: 7.02, y: 1.92, w: 2.0, h: 0.2,
    fontFace: 'Microsoft YaHei', fontSize: 16, bold: true, color: C.ink, margin: 0,
  });
  bulletBlock(slide, [
    ...company.outlook.slice(0, 2),
    company.moat[0],
    company.insight[0],
  ], 7.05, 2.28, 5.05, 3.45, 14.5);
  addFooter(slide, company.accent, company.sourceNote);
  warnIfSlideHasOverlaps(slide, pptx);
  warnIfSlideElementsOutOfBounds(slide, pptx);
}
...
function addCoverSlide() {
  ...
  slide.addText('汇报主题：全球模式识别公司案例研究', {
...
addCoverSlide();
contentIntroSlides.forEach((item) => {
  if (item.cards) {
    addOverviewGridSlide(item);
  } else {
    addTwoColumnSlide(item, C.gold, '总论', '综合自各公司官方公开资料与课程任务要求。');
  }
});
...
companies.forEach((company) => {
  ...
  addScenarioSlide(company);
  addOpsSlide(company);
  addOutlookSlide(company);
  addPositionSlide(company);
  addRiskSlide(company);
  addInsightSlide(company);
});

contentComparisonSlides.forEach((item) => {
...
const outPath = path.join(__dirname, 'output', '模式识别_五家公司案例研究_100页_内容版.pptx');
